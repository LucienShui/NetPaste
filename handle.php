...
//    if (False) {
    if (!$it->exists($id)) {
        ...
        if ($flag) {
            ...
            <pre><code class="language-<?php echo htmlspecialchars($content['type']); ?> line-numbers-rows"><?php echo $content['text']; ?></code></pre>
            <?php
        } else {
            ?>
                ...
                <div class="col-sm-5">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input style="" name="password_right" value="<?php echo $password; ?>" title="pswdrt">
                            <input name="id" value="<?php echo $id; ?>" title="id">
                        </div>
                    </div>
